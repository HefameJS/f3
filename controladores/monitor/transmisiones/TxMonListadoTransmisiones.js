 ...
 */
class TxMonListadoTransmisiones extends TransmisionLigera {
	...
	async operar() {
		...
		this.log.info('Solicitud de listado de transmisiones con filtros', consultaRealizada);
		...
		try {
			...
			let errorFedicom = new ErrorFedicom('HTTP-400', 'Error al interpretar la consulta de transmisiones', 400);
...
TxMonListadoTransmisiones.CONDICIONES_AUTORIZACION = new CondicionesAutorizacion({
	grupoRequerido: 'FED3_CONSULTAS'
});


module.exports = TxMonListadoTransmisiones;